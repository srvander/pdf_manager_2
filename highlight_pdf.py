...
class HighlightPDF(CustomFrame):
    ...
    def create_widgets(self):
        ...
        self.toggle_button.configure(state=tk.DISABLED)  # Disable initially
        ...
        self.save_button = CustomButton_A(top_frame, text="GUARDAR", command=self.save_highlights, state=tk.DISABLED)
...
#function to restore all values to default:
    def restore_values(self):
        ...
        self.highlighting_enabled = False
        self.toggle_button.configure(text="ACTIVAR DESTACADO")
        ...
        self.save_button.configure(state=tk.DISABLED)  # Disable save button
    ...
    def load_pdf(self):
        ...
        if file_path:
            ...
            self.toggle_button.configure(state="normal")  # Enable toggle button
    ...
    def toggle_highlighting(self):
        ...
        self.toggle_button.configure(text="ACTIVAR DESTACADO" if self.highlighting_enabled == False else "DESACTIVAR DESTACADO")
