...
class CensorPDF(CustomFrame):
    ...
    def init_ui(self):
        ...
        self.censure_btn = CustomButton_A(censure_group, text="ACTIVAR CENSURA", 
                                   command=self.toggle_censure_mode, state=tk.DISABLED)
        ...
        self.save_button = CustomButton_A(edit_group, text="GUARDAR", 
    ...
    def select_pdf(self):
        ...
        if file_path:
            ...
            # Enable Undo, Redo, Censure and Save buttons when a file is selected
            self.undo_button.configure(state=tk.NORMAL)
            self.redo_button.configure(state=tk.NORMAL)
            self.censure_btn.configure(state=tk.NORMAL)
    ...
    def toggle_censure_mode(self):
        ...
        self.censure_btn.configure(text="DESACTIVAR" if self.censure_mode else "ACTIVAR CENSURA")
    ...
    def reset_state(self):
        ...
        self.undo_button.configure(state=tk.DISABLED)
        self.redo_button.configure(state=tk.DISABLED)
        self.censure_btn.configure(state=tk.DISABLED)
        self.censure_btn.configure(text="ACTIVAR CENSURA")
        self.zoom_out_button.configure(state=tk.DISABLED)
        self.zoom_in_button.configure(state=tk.DISABLED)
